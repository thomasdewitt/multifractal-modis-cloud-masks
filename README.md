...
![Parent simulation and selected MODIS-like sub-scenes](figures/parent_children_example.png)
...
Estimates of $D_{e,c}$ are $1.666\pm 0.011$ for the full $8192^2$ masks and $1.632\pm 0.009$ for the $1024\times 2048$ sub-scenes.
